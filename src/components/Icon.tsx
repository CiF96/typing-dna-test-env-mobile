...
export function Icon({
  ...
  if (name === "minus") {
    return (
      <Svg viewBox="0 0 409.6 409.6" width={size} height={size}>
        <G>
          <G>
            <Path
      ...
      <Svg viewBox="0 0 512 512" width={size} height={size}>
        ...
        <G>
          <G>
            <Path
              fill={color}
              d="M455.285,427l50.857-50.857c7.811-7.811,7.811-20.475,0-28.285c-7.811-7.811-20.474-7.811-28.284,0L427,398.715 l-50.858-50.858c-7.811-7.811-20.474-7.811-28.284,0c-7.81,7.811-7.811,20.475,0,28.285L398.715,427l-50.857,50.857 c-7.811,7.811-7.811,20.475,0,28.285C351.763,510.048,356.881,512,362,512c5.119,0,10.237-1.952,14.142-5.857L427,455.285 l50.858,50.858C481.763,510.048,486.881,512,492,512c5.119,0,10.237-1.952,14.142-5.857c7.811-7.811,7.811-20.475,0-28.285 L455.285,427z"
            />
          </G>
        </G>
      </Svg>
